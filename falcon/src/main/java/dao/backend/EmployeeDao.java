...
////		int empId = sc.nextInt();
	...
	{
		Employee e;
		System.out.println("Comes here also post method");
...
//		    pm.close();
	...
	public static Employee search(int b)
	{
		Employee p=null;
		Transaction tx=pm.currentTransaction();
		System.out.println("Comes hwere");
		try
		{
			tx.begin();
...
////				Employee emp1 = s.getTrackInJSON();
	...
	{
		Employee e;
		System.out.println("Comes here also put method");
...
//		    pm.close();
	...
	{
		Employee e=null;
		System.out.println("Comes here also delete method");
		Employee employee=null;
